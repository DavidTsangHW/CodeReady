...
Option Explicit On
Module Bas_LogError
	Public Const FILE_PROGRAM_ERROR As String = "error.log"
...
ErrorHandler: 
	...
	Public Function LogFormError(ByVal FrmName As String, ByVal Routine As String, ByVal ErrDesc As String) As Boolean
		...
		On Error GoTo ErrorHandler
		Details = "Date: " & VB6.Format(Now, "yyyy/mm/dd") & vbNewLine
		Details = Details & "Time: " & VB6.Format(Now, "hh:mm:ss") & vbNewLine
